...
class DetectorConfig:
    ...
    cellpose_overlap_split_pairlike_enabled: bool = True
    cellpose_overlap_split_pairlike_min_area_ratio: float = 0.78
    cellpose_overlap_split_pairlike_max_area_ratio: float = 1.55
    cellpose_overlap_split_pairlike_min_aspect_ratio: float = 1.85
    cellpose_overlap_split_pairlike_max_aspect_ratio: float = 3.60
    cellpose_overlap_split_pairlike_min_eccentricity: float = 0.82
    cellpose_overlap_split_pairlike_max_extent: float = 0.72
    cellpose_overlap_split_pairlike_peak_min_distance: int = 3
    cellpose_overlap_split_pairlike_peak_abs_threshold: float = 0.42
    cellpose_overlap_split_pairlike_min_peak_distance_scale: float = 0.55
    cellpose_overlap_split_pairlike_min_child_area_ratio: float = 0.24
    cellpose_overlap_split_pairlike_max_child_area_ratio: float = 3.00
    cellpose_overlap_split_pairlike_brown_weight: float = 0.70
    cellpose_overlap_split_pairlike_gaussian_sigma: float = 1.0
